...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cardHolder: Schema.Attribute.String & Schema.Attribute.Required;
    cardCvc: Schema.Attribute.Password & Schema.Attribute.Required;
    cardExpiry: Schema.Attribute.Integer & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
